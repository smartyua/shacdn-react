...
export const COMPONENT_CATALOG: ComponentMeta[] = [
  ...
  { name: 'Calendar', folder: 'Calendar', description: 'Month grid date picker with single and range selection', tasks: ['calendar', 'date', 'date range'], exports: ['Calendar'] },
  ...
  { name: 'Card', folder: 'Card', description: 'Content card with header/footer', tasks: ['card', 'panel', 'container'], exports: ['Card', 'CardHeader', 'CardTitle', 'CardDescription', 'CardAction', 'CardContent', 'CardFooter'] },
  { name: 'Checkbox', folder: 'Checkbox', description: 'Boolean checkbox input', tasks: ['checkbox', 'check', 'form'], exports: ['Checkbox'] },
  { name: 'CheckboxCards', folder: 'CheckboxCards', description: 'Selectable cards for multiple choices (plans, add-ons, peripherals)', tasks: ['checkbox cards', 'multi select cards', 'plan picker', 'addon cards'], exports: ['CheckboxCards', 'CheckboxCardsItem'] },
  { name: 'CheckboxGroup', folder: 'CheckboxGroup', description: 'Labeled checkbox list with shared value array', tasks: ['checkbox group', 'checkbox list', 'settings checkboxes'], exports: ['CheckboxGroup', 'CheckboxGroupItem'] },
  ...
  { name: 'Chart', folder: 'Chart', description: 'Zero-dep SVG charts: bar, grouped bar, donut, sparkline', tasks: ['chart', 'graph', 'analytics', 'donut', 'sparkline'], exports: ['ChartContainer', 'BarChart', 'GroupedBarChart', 'DonutChart', 'Sparkline'] },
  ...
  { name: 'DataList', folder: 'DataList', description: 'Key/value definition list for detail and settings rows', tasks: ['data list', 'definition list', 'key value', 'dl'], exports: ['DataList', 'DataListItem', 'DataListLabel', 'DataListValue'] },
  ...
  { name: 'DateRangePicker', folder: 'DateRangePicker', description: 'Start/end date input with range calendar popup', tasks: ['date range', 'range picker', 'period'], exports: ['DateRangePicker'] },
  ...
  { name: 'Drawer', folder: 'Drawer', description: 'Side panel / sheet overlay', tasks: ['drawer', 'sidebar', 'sheet', 'panel'], exports: ['Drawer', 'DrawerContent', 'DrawerHeader', 'DrawerTitle', 'DrawerDescription'] },
  {
    name: 'DropdownMenu',
    folder: 'DropdownMenu',
    description: 'Dropdown action menu with checkbox, radio, shortcut and nested submenu parts',
    tasks: ['dropdown', 'menu', 'actions', 'context actions'],
    exports: [
      'DropdownMenu',
      'DropdownMenuTrigger',
      'DropdownMenuContent',
  ...
  { name: 'RadioCards', folder: 'RadioCards', description: 'Selectable cards for a single choice (plan, shipping, billing)', tasks: ['radio cards', 'plan cards', 'choice cards', 'shipping method'], exports: ['RadioCards', 'RadioCardsItem'] },
  ...
  { name: 'TabNav', folder: 'TabNav', description: 'Link-based navigation that looks like tabs (no panels)', tasks: ['tab nav', 'tab navigation', 'page tabs', 'settings nav'], exports: ['TabNav', 'TabNavLink'] },
...
export const INTERNAL_DEPS: Record<string, string[]> = {
  ...
  DateRangePicker: ['Calendar', 'Floating'],
  Dialog: ['Button', 'Modal'],
  Drawer: ['Modal'],
...
export const SCREEN_PATTERNS = [
  ...
  },
  {
    ...
    description: 'Personal finance admin: KPI tiles, donut income mix, grouped expense bars, transactions, saving goal, wallet cards',
    path: 'src/screens/Dashboard/pages/Finance',
    components: ['Card', 'Badge', 'Button', 'Table', 'Avatar', 'Chart', 'ProgressRing', 'DateRangePicker', 'Dialog'],
  },
];
