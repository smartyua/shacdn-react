...
import { getEmbedContext } from './embed';
...
const TranscodingDashboard = lazy(() =>
  import('./screens/TranscodingDashboard/TranscodingDashboard').then((m) => ({
...
const routerBasename = getEmbedContext()?.basename;
