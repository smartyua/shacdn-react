...
describe('Tabs', () => {
  ...
  it('aligns triggers to the start so a constrained list can scroll to the first one', () => {
    renderTabs();

    expect(window.getComputedStyle(screen.getByRole('tablist')).justifyContent).toBe('flex-start');
  });
