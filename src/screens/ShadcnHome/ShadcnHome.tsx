...
import { HomeCompositionShowcase } from './HomeCompositionShowcase';
      ...
      <main className={styles.main} id="shacdn-home-top">
          ...
          <div className={styles.showcase}>
              ...
              <CardContent className={styles.fieldGrid}>
                ...
                <div className={styles.fieldRow}>
                  ...
                  <div className={styles.fieldGrow}>
                    ...
                    <NativeSelect id="home-exp-mm" aria-label={copy.payment.monthAriaLabel} defaultValue="">
                  ...
                  <div className={styles.fieldGrow}>
                    ...
                    <NativeSelect id="home-exp-yy" aria-label={copy.payment.yearAriaLabel} defaultValue="">
                      <option value="" disabled>
            ...
            <Card className={`${styles.cell} ${styles.cellThird}`}>
              ...
              <CardContent>
                <NativeSelect aria-label={copy.referral.ariaLabel} defaultValue="">
                  <option value="" disabled>
